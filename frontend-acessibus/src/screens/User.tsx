...
import type { UserScreenProps } from '../types/navigation';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Nome: {user?.nome ?? 'Usuário'}</Text>

        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('Update')} accessibilityRole="button" accessibilityLabel="Editar perfil">
          <Text style={styles.buttonText}>Editar Perfil</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.button} onPress={handleSignOut} accessibilityRole="button" accessibilityLabel="Fazer logoff">
